                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-semibold">
                            <i class="ti ti-file-text me-2"></i>Form Edit Role
                        </h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="name" name="name"
                                    ...
                                    placeholder="Contoh: Dokter, Admin, Kasir, Perawat" autocomplete="off">
                            </div>
                        ...
                        <div class="mb-4">
                                ...
                                <div class="row g-2" id="permissionList">
                                    @foreach ($permission as $value)
                                        <div class="col-md-4 col-sm-6 permission-item">
                                            <label
                                                class="d-flex align-items-center gap-2 p-2 rounded hover-bg-light cursor-pointer">
                            ...
                            <small class="text-muted d-block mt-2">
                                <i class="ti ti-help me-1"></i>Permission yang dicentang akan diberikan ke role ini
                            </small>
                            @error('permission')
                                <div class="invalid-feedback d-block mt-1">
                                    <i class="ti ti-alert-circle me-1"></i>{{ $message }}
