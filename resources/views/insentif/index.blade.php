                                        ...
                                        <div class="tab-pane fade @if ($first) show active @endif"
                                            ...
                                            <div
                                                ...
                                                <h5 class="mb-0 fw-semibold">
                                                    ...
                                                    Rule untuk Role: <span class="text-primary">{{ $r->name }}</span>
                                                </h5>
                                            ...
                                            @if ($r->getRuleInsentif->isEmpty())
                                                ...
                                                <div class="text-center py-5">
                                                    ...
                                                    <p class="text-muted mb-0">Belum ada rule insentif untuk role ini.</p>
                                                    <a href="{{ route('Insentif.create', $r->id) }}"
                                                    ...
                                                    <table class="table table-hover align-middle mb-0">
                                                        ...
                                                        <tbody>
                                                            @foreach ($r->getRuleInsentif as $idx => $rule)
                                                                <tr>
                                                                    <td class="text-center fw-semibold">{{ $idx + 1 }}
                                                                    </td>
                                                                    ...
                                                                    <td class="text-end fw-semibold">
                                                                        ...
                                                                        @if ($rule->TipeNominal === 'percent')
                                                                            <small class="text-muted d-block fs-7">(% dari
                                                                                omzet)</small>
                                                                        @endif
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        @php
                                                                            $berlakuLabel = match ($rule->BerlakuPer) {
                                                                                'shift' => 'Per Shift',
                                                                                'harian' => 'Harian',
                                                                                'mingguan' => 'Mingguan',
                                                                                'bulanan' => 'Bulanan',
                                                                    ...
                                                                    <td class="text-center">
                                                                        <div class="btn-group btn-group-sm">
                                                                            <a href="{{ route('Insentif.edit', $rule->id) }}"
