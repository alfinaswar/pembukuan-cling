        ...
        <div class="page-title-head d-flex align-items-center flex-wrap gap-2 mb-4">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0 fw-semibold">
                    <i class="ti ti-edit me-2 text-primary"></i>Edit Metode Pembayaran
                </h4>
            </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-semibold">
                            <i class="ti ti-file-text me-2"></i>Form Edit Metode Pembayaran
                        </h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('MetodePembayaran.update', encrypt($MasterMetodePembayaran->id)) }}"
                            method="POST" id="formEditMetodePembayaran">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="Nama" name="Nama"
                                        ...
                                        placeholder="Contoh: Tunai, Transfer Bank, QRIS, Kartu Kredit, dll"
                                        autocomplete="off">
                                </div>
                                @error('Nama')
