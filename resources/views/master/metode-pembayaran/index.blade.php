        ...
        <div class="page-title-head d-flex align-items-center flex-wrap gap-2 mb-4">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0 fw-semibold">
                    <i class="ti ti-credit-card me-2 text-primary"></i>Master Metode Pembayaran
                </h4>
            </div>
                    ...
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0 fw-semibold">
                                <i class="ti ti-list me-2"></i>Data Metode Pembayaran
                            </h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    title: 'Hapus Data?',
                    html: `Anda akan menghapus metode pembayaran:<br><strong class="text-primary">${nama}</strong><br>Tindakan ini tidak dapat dibatalkan!`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('MetodePembayaran.destroy', ':id') }}".replace(
                                ':id', id),
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            ...
                            success: function(response) {
                                if (response.status === 200) {
                                    ...
                                    $('#metodePembayaranTable').DataTable().ajax.reload(
                                        null, false);
                                } else {
            ...
            $('#metodePembayaranTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('MetodePembayaran.index') }}",
                    type: 'GET'
                },
                language: {
