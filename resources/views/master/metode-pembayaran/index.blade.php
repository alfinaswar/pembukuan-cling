    ...
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0">Master Metode Pembayaran</h4>
            </div>
            <div class="text-end">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header justify-content-between">
                        ...
                        <a href="{{ route('MetodePembayaran.create') }}" class="btn btn-primary btn-sm">Tambah Metode
                            Pembayaran</a>
                    </div>
                    <div class="card-body">
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.status === 200) {
                                        ...
                                        $('#metodePembayaranTable').DataTable().ajax
                                            .reload();
                                    } else {
