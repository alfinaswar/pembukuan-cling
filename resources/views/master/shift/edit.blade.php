        ...
        <div class="page-title-head d-flex align-items-center flex-wrap gap-2 mb-4">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0 fw-semibold">
                    <i class="ti ti-edit me-2 text-primary"></i>Edit Shift Kerja
                </h4>
            </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-semibold">
                            <i class="ti ti-file-text me-2"></i>Form Edit Shift Kerja
                        </h5>
                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="Nama" name="Nama"
                                        ...
                                        placeholder="Contoh: Pagi, Siang, Malam, dll" autocomplete="off">
                                </div>
                                @error('Nama')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="time" id="JamMulai" name="JamMulai"
                                        ...
                                        value="{{ old('JamMulai', $MasterShift->JamMulai) }}" required step="60"
                                        min="00:00" max="23:59" data-provider="timepickr" data-time-hrs="true">
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="time" id="JamSelesai" name="JamSelesai"
                                        ...
                                        value="{{ old('JamSelesai', $MasterShift->JamSelesai) }}" required step="60"
                                        min="00:00" max="23:59" data-provider="timepickr" data-time-hrs="true">
                                </div>
                                <small class="text-muted d-block mt-1">
