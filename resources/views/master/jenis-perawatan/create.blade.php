    ...
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0">Tambah Jenis Perawatan</h4>
            </div>
            <div class="text-end">
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Master</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('JenisPerawatan.index') }}">Jenis Perawatan</a></li>
                    <li class="breadcrumb-item active">Tambah Jenis Perawatan</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Form Tambah Jenis Perawatan</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('JenisPerawatan.store') }}" method="POST">
                            @csrf
                            <div class="mb-1">
                                <label for="nama" class="form-label">Nama <span class="text-danger">*</span></label>
                                <input type="text" id="nama" name="Nama"
                                    class="form-control @error('Nama') is-invalid @enderror" value="{{ old('Nama') }}"
                                    required placeholder="Masukkan nama jenis perawatan">
                                @error('Nama')
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="tarif" name="Tarif"
                                    ...
                                    required placeholder="Masukkan tarif">
                                @error('Tarif')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
