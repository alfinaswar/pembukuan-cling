    ...
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0">Master Jenis Perawatan</h4>
            </div>
            <div class="text-end">
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Master</a></li>
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Jenis Perawatan</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header justify-content-between">
                        <h4 class="card-title">Data Jenis Perawatan</h4>
                        <a href="{{ route('JenisPerawatan.create') }}" class="btn btn-primary btn-sm">Tambah Jenis
                            Perawatan</a>
                    </div>
                    <div class="card-body">
        ...
        <script>
            $(document).ready(function() {
                $('body').on('click', '.btn-delete', function() {
                    ...
                    Swal.fire({
                        title: 'Hapus Data?',
                        text: "Apakah Anda yakin ingin menghapus jenis perawatan ini?",
                        icon: 'warning',
