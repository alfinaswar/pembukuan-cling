        ...
        <div class="page-title-head d-flex align-items-center flex-wrap gap-2 mb-4">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0 fw-semibold">
                    <i class="ti ti-plus me-2 text-primary"></i>Tambah Klinik
                </h4>
            </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-semibold">
                            <i class="ti ti-file-text me-2"></i>Form Data Klinik
                        </h5>
                    </div>

                    <!-- Card Body -->
                    <div class="card-body p-4">
                        <form action="{{ route('Klinik.store') }}" method="POST" id="formKlinik">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="Nama" name="Nama"
                                        ...
                                        required placeholder="Contoh: Klinik Gigi Sehat, Dental Care Plus, dll"
                                        autocomplete="off">
                                </div>
                                @error('Nama')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group align-items-start">
                                    ...
                                    <textarea id="Alamat" name="Alamat" class="form-control @error('Alamat') is-invalid @enderror" rows="3"
                                        required placeholder="Masukkan alamat lengkap klinik">{{ old('Alamat') }}</textarea>
                                </div>
                                @error('Alamat')
                                    <div class="invalid-feedback d-block mt-1">
                                        <i class="ti ti-alert-circle me-1"></i>{{ $message }}
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" id="NoTelp" name="NoTelp"
                                        ...
                                        value="{{ old('NoTelp') }}" placeholder="Contoh: 021-12345678 / 0812-3456-7890"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" id="Email" name="Email"
                                        ...
                                        value="{{ old('Email') }}" placeholder="contoh@klinik.com" autocomplete="email">
                                </div>
                                <small class="text-muted d-block mt-1">
