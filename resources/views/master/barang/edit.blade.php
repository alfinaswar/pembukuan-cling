    ...
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center flex-wrap gap-2 mb-4">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0 fw-semibold"><i class="ti ti-edit me-2 text-primary"></i>Edit Barang</h4>
            </div>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-semibold"><i class="ti ti-file-text me-2"></i>Form Edit Barang</h5>
                    </div>
                            ...
                            <div class="row g-3">
                                {{-- <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="KodeBarang" class="form-control @error('KodeBarang') is-invalid @enderror" value="{{ old('KodeBarang', $barang->KodeBarang) }}" required autocomplete="off" style="text-transform: uppercase;">
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="NamaBarang" class="form-control @error('NamaBarang') is-invalid @enderror" value="{{ old('NamaBarang', $barang->NamaBarang) }}" required autocomplete="off">
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="KategoriBarangId" class="form-select @error('KategoriBarangId') is-invalid @enderror" required>
                                            ...
                                            @foreach($kategoris as $kat)
                                                <option value="{{ $kat->id }}" {{ old('KategoriBarangId', $barang->KategoriBarangId) == $kat->id ? 'selected' : '' }}>{{ $kat->Nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
