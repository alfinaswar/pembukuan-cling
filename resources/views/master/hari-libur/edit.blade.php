        ...
        <div class="page-title-head d-flex align-items-center flex-wrap gap-2 mb-4">
            <div class="flex-grow-1">
                <h4 class="page-main-title m-0 fw-semibold">
                    <i class="ti ti-edit me-2 text-warning"></i>Edit Hari Libur
                </h4>
            </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-semibold">
                            <i class="ti ti-file-text me-2"></i>Edit Data Hari Libur
                        </h5>
                    </div>

                    <!-- Card Body -->
                    <div class="card-body p-4">
                        <form action="{{ route('MasterHariLibur.update', $masterHariLibur->id) }}" method="POST"
                            id="formMasterHariLibur">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="NamaHari" name="NamaHari"
                                        ...
                                        value="{{ old('NamaHari', $masterHariLibur->NamaHari) }}" required
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" id="TanggalLibur" name="TanggalLibur"
                                        ...
                                        value="{{ old('TanggalLibur', $masterHariLibur->TanggalLibur) }}" required
                                        autocomplete="off">
                                </div>
                                @error('TanggalLibur')
                                    <div class="invalid-feedback d-block mt-1">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="Keterangan" name="Keterangan"
                                        ...
                                        value="{{ old('Keterangan', $masterHariLibur->Keterangan) }}"
                                        placeholder="Opsional: Keterangan tambahan" autocomplete="off">
                                </div>
                                @error('Keterangan')
                                    <div class="invalid-feedback d-block mt-1">
                                        <i class="ti ti-alert-circle me-1"></i>{{ $message }}
